  ...
  <v-date-picker class="inline-block h-full" v-model="date">
    <template v-slot="{ inputValue, togglePopover }">
      <div class="flex items-center">
        <button
          class="p-2 bg-blue-100 border border-blue-200 
          hover:bg-blue-200 text-blue-600 rounded-l 
        ...
        >
          ...
          >
            ...
            <path
              ...
              2v12h14V6H3zm2-6h2v2H5V0zm8 0h2v2h-2V0zM5 
              9h2v2H5V9zm0 4h2v2H5v-2zm4-4h2v2H9V9zm0 
...
<script>
    export default {
        data() {
            return {
                date: new Date(),
                dateSend: new Date(2021,12,1),
            };
        },
        methods: {
            dateInput: function(input) {
                this.$emit("dateSend", input);
