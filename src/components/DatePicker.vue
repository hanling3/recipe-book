        ...
        <v-date-picker v-model="selected.date">
            <template #default="{  togglePopover, hidePopover }">
                ...
                <button
                    ...
                    class="flex items-center bg-indigo-100 hover:bg-indigo-200 text-sm 
                    text-indigo-600 font-semibold h-8 px-2 m-1 rounded-lg 
                    border-2 border-transparent focus:border-indigo-600 focus:outline-none"
